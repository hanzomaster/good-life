...
export const suggestSongs = [
  ...
  },
  {
    ...
    description: "Rule meditation like lion",
    like: false,
    uri: "../assets/music/giua-dai-lo-Dong-Tay.mp3",
  },
  {
    id: 3,
    ...
    description: "Rule meditation like lion",
    like: false,
    uri: "../assets/music/the-way-that-i-love-you.mp3",
  },
  {
    id: 4,
    ...
    description: "Rule meditation like lion",
    like: false,
    uri: "../assets/music/thang-tu-la-loi-noi-doi-cua-em.mp3",
  },
  {
    id: 5,
    ...
    description: "Rule meditation like lion",
    like: false,
    uri: "../assets/music/nguoi-hay-quen-em-di.mp3",
  },
  {
    id: 6,
    name: "Stay",
...
const naturalSongs: Array<Song> = [
  {
    ...
    description: "Rule meditation like lion",
    like: false,
    uri: require("../assets/music/giua-dai-lo-Dong-Tay.mp3"),
  },
  {
    id: 0,
    name: "Tình sầu",
    ...
    description: "Rule meditation like lion",
    like: true,
    uri: require("../assets/music/tinh-sau.mp3"),
  },
  {
    id: 3,
    name: "The way that I love you",
    ...
    description: "Rule meditation like lion",
    like: false,
    uri: require("../assets/music/the-way-that-i-love-you.mp3"),
  },
  {
    id: 1,
    name: "Matilda",
    ...
    description: "Rule meditation like lion",
    like: false,
    uri: require("../assets/music/Matilda.mp3"),
  },

  {
    ...
    description: "Rule meditation like lion",
    like: false,
    uri: require("../assets/music/thang-tu-la-loi-noi-doi-cua-em.mp3"),
  },
  {
    id: 5,
    name: "Người hãy quên em đi",
    ...
    description: "Rule meditation like lion",
    like: false,
    uri: require("../assets/music/nguoi-hay-quen-em-di.mp3"),
  },
  {
    id: 6,
    name: "Stay",
...
export const MusicScreen = (props: ScreenProps<"Music">) => {
  ...
  return (
    <AudioProvider>
      <SafeAreaView className="absolute inset-0 bg-red-100">
        {audioState.playlist.map((song, index) => (
          <TouchableOpacity onPress={() => handlePlay(index)} key={index}>
            <Text>{song.name}</Text>
          </TouchableOpacity>
        ))}
      </SafeAreaView>
