    ...
    <SafeAreaView className="absolute inset-0 content-end bg-[#FFF4ED]">
      <View className=" relative top-0 right-0 items-end p-0">
        <Image
          ...
          source={require("../../common/landingpage4/topright.png")}
        />
      </View>
      ...
      <View className="relative right-0 flex-1 items-start">
        <Image
          ...
          source={require("../../common/landingpage4/centerleft.png")}
        />
      </View>
      ...
      <View className="absolute inset-x-0 mt-24 ml-auto mr-auto flex h-3/5 flex-col items-center justify-between align-baseline">
        <Image
          ...
          source={require("../../common/landingpage4/center.png")}
        />

        <View className=" relative inset-x-0 mx-auto flex h-1/3 w-full flex-col items-center justify-between">
          <Text className=" font-quicksand h-auto w-2/3 flex-wrap text-center text-2xl text-[#608144] ">
            MIND
          </Text>
      ...
      <View className="inset-x-0 mb-0 items-center ">
        <Image
          ...
          source={require("../../common/landingpage4/slider.png")}
        />
        <TouchableOpacity
        ...
        <View>
          <Image
            ...
            source={require("../../common/landingpage4/bottom.png")}
          />
        </View>
      </View>
    </SafeAreaView>
